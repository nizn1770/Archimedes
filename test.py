...
# Define GPIO pins
MOTOR_PIN = 36  # Physical pin 11
ALWAYS_HIGH_PIN = 27  # Use another available GPIO
PWM_PIN = 22  # PWM pin
...
GPIO.setup(ALWAYS_HIGH_PIN, GPIO.OUT)
GPIO.setup(PWM_PIN, GPIO.OUT)
GPIO.output(MOTOR_PIN, GPIO.HIGH)
GPIO.output(ALWAYS_HIGH_PIN, GPIO.HIGH)  # Set this pin to always HIGH
...
try:
    while True:
        ...
        GPIO.output(MOTOR_PIN, GPIO.HIGH if motor_on else GPIO.LOW)
        print("Motor ON" if motor_on else "Motor OFF")
